2026-3-25 Wed (3.2h): Ensure batch backtest be able to checkout any commit or release, including side branches. Resolve port conflict. Fix bug related to local testing. Release configuration. Review and revise leaderboard. Domain management.
