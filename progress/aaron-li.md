2025-8-20 Wed (6.8h): Debug and revise earning script. Fix embedded web service fetch errors due to notion API update. Upgrade embedded web service server package versions. Discussion on LP data, options, and bot performance. Debugging edge cases of fee earning analytics.
