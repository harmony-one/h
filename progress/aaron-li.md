2025-10-15 Wed (1.9h): Review top wallets identified using database, verify with lp-backtest scripts. Backtesting unit tests and end-to-end testing, refine backtesting server APIs, state handling such as time, balance, positions, pnl.
