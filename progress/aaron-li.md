2025-6-4 Wed (6.5h+): Extending Zodiac defi-kit for operations on Shadow and Sonic. Debug and fix issues with end-to-end operations on Aerodrome using Zodiac. Deploy new Multicall unwrapper.
