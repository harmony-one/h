2025-10-14 Tue (4.4h+): Unit tests and end-to-end testing for backtesting systems, refine APIs. Balance and position tracking in backtesting, API integration, testing.
