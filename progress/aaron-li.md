2025-10-22 Wed (2.2h): Include sanity check stats and swap counts in backtesting API response.  Scripts demoing backtesting on other platforms. Implement lp-hedger integration with backtesting APIs.
