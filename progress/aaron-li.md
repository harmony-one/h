2025-8-7 Thu (5.1h): Discussion on modelling, backtesting, hedging, profits and errors. Backtesting: data extraction. Backtesting: implement proxy rotation and auto-resume data collection; exporting data to csv.
