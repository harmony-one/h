2026-2-24 Tue (11.6h+): Execute strategies and evaluate backtest result. Q&A on running local backtest server, copy database, and running lp-hedger against local backtest server, and analyze the results.
