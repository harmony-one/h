2025-9-16 Tue (5.7h+): Revise earning script to include initial and closing state, fee from virtual-burns, and configurable fee-mode at closing state. Fix and end-to-end test staked statistics.
