2025-8-7 Thu (6.2h+): Backtesting: implement pool-based LP position scanner and extraction module. Backtesting: data extraction. Discussion on modelling, backtesting, hedging, profits and errors. Backtesting: implement proxy rotation and auto-resume data collection; exporting data to csv.
