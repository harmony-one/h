2025-10-17 Fri (4.0h): Backtesting example script, running on production data. Implement lp-hedger integration with backtesting APIs. Discussion on top wallets, copy trading implementations, testing.
