2025-10-15 Wed (2.7h+): Backtesting unit tests and end-to-end testing, refine backtesting server APIs, state handling such as time, balance, positions, pnl. Review top wallets identified using database, verify with lp-backtest scripts.
