2025-5-20 Tue (5.6h): End-to-end simulation for exit contract execution using local fork. Discussion on BTC options, perp, funding rate, lending, and liquidity provisioning data and strategies.
