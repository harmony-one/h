2025-8-6 Wed (3.2h+): Backtesting: database revision migration with alembic; scripts for LP positions and trades, end-to-end testing and stablizing data collection.
