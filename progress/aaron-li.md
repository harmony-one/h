2025-10-29 Wed (1.3h+): Separate DB connections of backtesting sessions and data reading. Q&A on backtesting and data. Refine backtesting for lp-hedger. Deploy BTC lp-hedger. Replace SugarPosition and contract implementations with more reliable query methods.
