2026-2-19 Thu (5.1h+): Implement and review backtesting client engine for random lp, random perp, random option, spread hedge, volatility harvesting, and copy trading. Implement and review volatility haverseting strategy code. Implement and review copy trading code in LP hedger for further revision.
