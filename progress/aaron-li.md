2026-1-11 Sun (3.2h+): End-to-end testing with LP Hedger. Call spread implementation on LP Hedger. Fix dot-country issues. Relaunch option historical data collection agent. Fix database issues.
