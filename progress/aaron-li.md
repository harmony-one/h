2025-9-12 Fri (2.7h+): Fix issues with liquidity to USD calculations, and earning calculations. Database migration and verification. Discussion on LP stats and earning data, and swap fee calculations.
