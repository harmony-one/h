2026-3-11 Wed (5.1h): Fix bugs in performance reporting. Auto-adjust deployment asset size. Implement auto-swap and swap constraints. Refactored performance tracker into a reusable mixin integrated across all strategies. Added return and CAGR calculations to performance CLI, built read-only Aerodrome RPC utility. Review copy-trade changes.
