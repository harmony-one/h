2025-10-17 Fri (2.1h+): Backtesting example script, running on production data. Implement lp-hedger integration with backtesting APIs. Discussion on top wallets, copy trading implementations, testing.
