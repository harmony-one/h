2025-10-15 Wed: Analysis of top wallet candidates from [master-doc](https://docs.google.com/document/d/1ofKwx2V15DGb5cAe2v6Q_fMZkMHYTz0JZKXjAr4cynw/edit?tab=t.0). Cleaned and published [repo](https://github.com/rikaa15/basescan-price) to get cbBTC price from basescan based on mint and burn transactions, now working on unifying with [timeline script](https://github.com/polymorpher/lp-backtest/blob/main/src/lp_backtest/scripts/timeline.py).
