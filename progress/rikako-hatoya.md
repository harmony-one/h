...
2025-03-28 Fri: Continued with USDC.e-scUSD on Euler: fixed calculations for metrics (big findings: COLLATERAL_ADDRESS = "0xB38D431e932fEa77d1dF0AE0dFE4400c97e597B8", Available Liquidity≈cash in vault−protocol-reserved amount), except discrepancy for "Available Liquidity" and "Max ROE" remains (though, "Max ROE" discrepancy seems not so worrysome). Pushed updates here and also investigating Euler's calculation method for "Available Liquidity".
