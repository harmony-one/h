...
From the operations side, as part of my on-call, I've fixed our monitoring for the Layer Zero tokens metics, issue was with 2 metrics which have exact labels, fix was just to add one more label to make the whole set unique.
