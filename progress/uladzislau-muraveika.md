...
My main focus was the testing area - I've created new test cases for the `debug_traceCall` operation block and state overrides, [test suite](https://github.com/harmony-one/harmony-test/pull/38) will run against every CI run after the merge insuring RPC integrity after each run.
