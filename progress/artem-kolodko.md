2025-04-08 Tue: completed research and testing of advanced vfat auto-rebalancing feautures that may be helpful for optimizing impermanent loss: buffer and cutoff, shared report with Stephen and Aaron. Started working on Euler portfolio, implemented current value locked in pool, started working on complete history of the wallet deposits to calculate total deposited amount and APR.
