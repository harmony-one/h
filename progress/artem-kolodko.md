2025-04-16 Wed: [reviewed](https://github.com/harmony-one/shadow-scraper/pull/3#pullrequestreview-2772671910) PR from Rika with Euler LP fees and PT rate script, tested it locally. Send new tasks for Rika and Frank to complete Aave and Euler research in the next few days. Started researching leveraged position on Euler, opened new position with modest leverage (5x). Synced with Li on best vaults, started working on the final list.
