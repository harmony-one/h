2025-05-30 Fri (ongoing): Fixed Uniswap V3 subgraph integration issues, delivering [daily metrics](https://github.com/harmony-one/portfolio-manager/pull/1) including position value, impermanent loss, PnL, and APR calculations. Implemented Jest-based execution framework with custom logging for clean backtesting analysis.
